...
namespace Demo.DnnConnect.DemoModule.Common
{
    ...
    public class DemoModuleAuthorizeAttribute : AuthorizeAttributeBase, IOverrideDefaultAuthLevel
    {
        private static readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(DemoModuleAuthorizeAttribute));
        public SecurityAccessLevel SecurityLevel { get; set; }
        public UserInfo User { get; set; }

        public DemoModuleAuthorizeAttribute()
        {
            SecurityLevel = SecurityAccessLevel.Admin;
        }

        public DemoModuleAuthorizeAttribute(SecurityAccessLevel accessLevel)
        {
