...
var pkg = require("./package.json"),
  pkgModule = require("./Server/DemoModule/dnn.json");
...
const allDlls = pkgModule.pathsAndFiles.assemblies
  .map((dll) => "bin/" + dll);
...
// Initialize watchers.
const ModuleWatcher = watcher("Server/DemoModule", pkg.dnn.pathsAndFiles.devSitePath + "\\DesktopModules\\MVC\\Demo\\DemoModule");
